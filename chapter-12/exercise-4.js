/* Exercise 4 from chapter 12 - Fixing scope
...
specialForms.set = (args, scope) => {
  ...
  let valueName = args[0].name;
  
  // Looping through scopes
  for (let i=scope; i; i=Object.getPrototypeOf(i)) {
    // If name of the variable is property in any scope, set and return the new value
    if (Object.prototype.hasOwnProperty.call(i, valueName)) {
      i[valueName] = value;
      return value;
    }
  }
  throw new ReferenceError("Ups");
};
